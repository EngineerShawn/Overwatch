...
Overwatch comes preloaded with a fairly sizable set of default command with their own permission levels
...
Adding commands can be really simple if you're familiar with javascript but very confusing otherwise. continue at your own risk and if you do make something cool, consider submitting a pull request and maybe it'll become a part of the default Overwatch commands :)

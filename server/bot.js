...
class Bot extends Client {
    ...
    start() {
        this.utils.log.assert((process.version == "v12.13.0"), "You are running unsupported artifacts, download a newer artifact or revert to version 4.0.0 of Overwatch");
        this.utils.log.assert((this.config.DiscordBotToken == "discord_token"), "Overwatch requires a discord bot token to run. Check the config.js");
        this.utils.log.assert((this.config.DiscordGuildId == "discord_guild_id"), "Overwatch requires a discord guildId to work properly. Check the config.js");
